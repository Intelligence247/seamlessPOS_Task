  ...
  return (
    <div className="pt-20">
      ...
      <div className="newletter bg-[#eff2f4] flex flex-col justify-center items-center py-6">
        ...
        <div className="mailSubscribe flex items-center flex-row gap-4">
          <div className="mail h-8 w-[20rem] flex items-center rounded-lg gap-3 bg-white px-2 mt-4">
          ...
          <button className="h-9 bg-primaryblue px-5 text-white rounded-lg">Subscribe</button>
        </div>
      </div>
    </div>
  );
