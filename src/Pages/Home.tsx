...
<div className="lg:w-1/2 w-2/3 flex justify-center h-full flex-col m-auto gap-8">
        <h1 className=" font-semibold lg:text-4xl text-2xl  flex flex-col">Latest Trending <p className="lg:text-4xl text-2xl pt-4 font-bold ">Electronic Materials</p></h1>
        <button className="px-4 py-2 bg-primary_green w-max text-white rounded-lg">Learn more</button>
        </div>
      </div>
